...
//    ],
    ...
    [
        ...
        'attribute' => 'ebook',
        'value'=>function($model){
            return (empty($model->ebook))?"(Không có)":\yii\helpers\Html::a('<i class="fa fa-book"></i> Xem',$model->ebook,['class'=>' iframe-btn2 btn btn-warning']);
        },
        'format'=>'raw'
    ],
    [
...
//    ],
    ...
    [
        ...
        'value' => function ($model) {
            if($model->hot==1){
                return Yii::$app->controller->renderPartial('getcauhoi', ['model' => $model]);
            }
