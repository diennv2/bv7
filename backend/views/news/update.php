...
<script>
    $(document).ready(function () {
        ...
        CKEDITOR.replace('noidung',{
            language: 'vi',
            filebrowserBrowseUrl: '/admin/admin/getfilemanagerforck',
            filebrowserUploadUrl: '/admin/admin/getfilemanagerforck',
            filebrowserImageBrowseUrl: '/admin/admin/getfilemanagerforck'
        });
        CKEDITOR.replace( 'brief' ,{
            ...
            filebrowserImageBrowseUrl :'/2595fcc932fcbc933591f65b0927f6ad/responsive_filemanager/filemanager/dialog.php?type=2&akey=<?=sha1("Karion3e0d56c94e15c78d3fe012bc33aba5252020" . sha1($nowfullstring))?>&editor=ckeditor&fldr='
        });
    })
