if (function (t, e) {
    ...
    "use strict";
    var i = [], n = t.document, o = Object.getPrototypeOf, r = i.slice, s = i.concat, a = i.push, l = i.indexOf, c = {},
        d = c.toString, u = c.hasOwnProperty, p = u.toString, f = p.call(Object), h = {};
    ...
    }, m = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, y = /^-ms-/, b = /-([a-z])/g, w = function (t, e) {
        return e.toUpperCase()
    };

    function x(t) {
        var e = !!t && "length" in t && t.length, i = g.type(t);
    ...
    g.fn = g.prototype = {
        ...
        for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" == typeof s || g.isFunction(s) || (s = {}), a === l && (s = this, a--); a < l; a++) if (null != (t = arguments[a])) for (e in t) i = s[e], s !== (n = t[e]) && (c && n && (g.isPlainObject(n) || (o = Array.isArray(n))) ? (o ? (o = !1, r = i && Array.isArray(i) ? i : []) : r = i && g.isPlainObject(i) ? i : {}, s[e] = g.extend(c, r, n)) : void 0 !== n && (s[e] = n));
        return s
    }, g.extend({
        expando: "jQuery" + ("3.2.1" + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (t) {
            ...
            var e, i;
            return !(!t || "[object Object]" !== d.call(t) || (e = o(t)) && ("function" != typeof (i = u.call(e, "constructor") && e.constructor) || p.call(i) !== f))
            ...
            var n, o, r = 0, a = [];
            if (x(t)) for (n = t.length; r < n; r++) null != (o = e(t[r], r, i)) && a.push(o); else for (r in t) null != (o = e(t[r], r, i)) && a.push(o);
            return s.apply([], a)
    ...
    var T = function (t) {
        var e, i, n, o, r, s, a, l, c, d, u, p, f, h, v, g, m, y, b, w = "sizzle" + 1 * new Date, x = t.document, T = 0,
            k = 0, $ = st(), C = st(), S = st(), E = function (t, e) {
                return t === e && (u = !0), 0
            }, A = {}.hasOwnProperty, D = [], j = D.pop, O = D.push, N = D.push, L = D.slice, P = function (t, e) {
            ...
            z = new RegExp("^" + H + "*," + H + "*"), _ = new RegExp("^" + H + "*([>+~]|" + H + ")" + H + "*"),
            U = new RegExp("=" + H + "*([^\\]'\"]*?)" + H + "*\\]", "g"), B = new RegExp(R),
            X = new RegExp("^" + q + "$"), V = {
                ID: new RegExp("^#(" + q + ")"),
                CLASS: new RegExp("^\\.(" + q + ")"),
                TAG: new RegExp("^(" + q + "|[*])"),
            ...
            J = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, K = /[+~]/,
            Z = new RegExp("\\\\([\\da-f]{1,6}" + H + "?|(" + H + ")|.)", "ig"), tt = function (t, e, i) {
                var n = "0x" + e - 65536;
        ...
        function rt(t, e, n, o) {
            ...
            if (!o && ((e ? e.ownerDocument || e : x) !== f && p(e), e = e || f, v)) {
                if (11 !== T && (u = J.exec(t))) if (r = u[1]) {
                    ...
                    if ((r = u[3]) && i.getElementsByClassName && e.getElementsByClassName) return N.apply(n, e.getElementsByClassName(r)), n
                }
                if (i.qsa && !S[t + " "] && (!g || !g.test(t))) {
                    if (1 !== T) y = e, m = t; else if ("object" !== e.nodeName.toLowerCase()) {
                        for ((d = e.getAttribute("id")) ? d = d.replace(et, it) : e.setAttribute("id", d = w), a = (h = s(t)).length; a--;) h[a] = "#" + d + " " + mt(h[a]);
                        m = h.join(","), y = K.test(t) && vt(e.parentNode) || e
                    }
                    if (m) try {
                        return N.apply(n, y.querySelectorAll(m)), n
                    } catch (t) {
                    } finally {
        ...
        for (e in i = rt.support = {}, r = rt.isXML = function (t) {
            ...
            return s !== f && 9 === s.nodeType && s.documentElement ? (h = (f = s).documentElement, v = !r(f), x !== f && (o = f.defaultView) && o.top !== o && (o.addEventListener ? o.addEventListener("unload", nt, !1) : o.attachEvent && o.attachEvent("onunload", nt)), i.attributes = lt((function (t) {
                ...
                return n || (1 & (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1) || !i.sortDetached && e.compareDocumentPosition(t) === n ? t === f || t.ownerDocument === x && b(x, t) ? -1 : e === f || e.ownerDocument === x && b(x, e) ? 1 : d ? P(d, t) - P(d, e) : 0 : 4 & n ? -1 : 1)
            } : function (t, e) {
                if (t === e) return u = !0, 0;
                var i, n = 0, o = t.parentNode, r = e.parentNode, s = [t], a = [e];
                if (!o || !r) return t === f ? -1 : e === f ? 1 : o ? -1 : r ? 1 : d ? P(d, t) - P(d, e) : 0;
                if (o === r) return dt(t, e);
                for (i = t; i = i.parentNode;) s.unshift(i);
                for (i = e; i = i.parentNode;) a.unshift(i);
                for (; s[n] === a[n];) n++;
                return n ? dt(s[n], a[n]) : s[n] === x ? -1 : a[n] === x ? 1 : 0
            }, f) : f
        }, rt.matches = function (t, e) {
            return rt(t, null, null, e)
        }, rt.matchesSelector = function (t, e) {
            if ((t.ownerDocument || t) !== f && p(t), e = e.replace(U, "='$1']"), i.matchesSelector && v && !S[e + " "] && (!m || !m.test(e)) && (!g || !g.test(e))) try {
                var n = y.call(t, e);
            ...
            preFilter: {
                ATTR: function (t) {
                    ...
                    var e, i = !t[6] && t[2];
                    return V.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : i && B.test(i) && (e = s(i, !0)) && (e = i.indexOf(")", i.length - e) - i.length) && (t[0] = t[0].slice(0, e), t[2] = i.slice(0, e)), t.slice(0, 3))
                }
            },
            filter: {
                TAG: function (t) {
                    ...
                    return 1 === n && 0 === o ? function (t) {
                        ...
                        var c, d, u, p, f, h, v = r !== s ? "nextSibling" : "previousSibling", g = e.parentNode,
                        ...
                        if (g) {
                            ...
                            if (h = [s ? g.firstChild : g.lastChild], s && y) {
                                for (b = (f = (c = (d = (u = (p = g)[w] || (p[w] = {}))[p.uniqueID] || (u[p.uniqueID] = {}))[t] || [])[0] === T && c[1]) && c[2], p = f && g.childNodes[f]; p = ++f && p && p[v] || (b = f = 0) || h.pop();) if (1 === p.nodeType && ++b && p === e) {
                                    d[t] = [T, f, b];
                                    break
                                }
                            } else if (y && (b = f = (c = (d = (u = (p = e)[w] || (p[w] = {}))[p.uniqueID] || (u[p.uniqueID] = {}))[t] || [])[0] === T && c[1]), !1 === b) for (; (p = ++f && p && p[v] || (b = f = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== m : 1 !== p.nodeType) || !++b || (y && ((d = (u = p[w] || (p[w] = {}))[p.uniqueID] || (u[p.uniqueID] = {}))[t] = [T, b]), p !== e));) ;
                    ...
                    return o[w] ? o(e) : o.length > 1 ? (i = [t, t, "", e], n.setFilters.hasOwnProperty(t.toLowerCase()) ? at((function (t, i) {
                        for (var n, r = o(t, e), s = r.length; s--;) t[n = P(t, r[s])] = !(i[n] = r[s])
                    })) : function (t) {
                        return o(t, 0, i)
                    }) : o
                }
            ...
            pseudos: {
                not: at((function (t) {
                    ...
                    return X.test(t || "") || rt.error("unsupported lang: " + t), t = t.replace(Z, tt).toLowerCase(), function (e) {
                        var i;
                        do {
        ...
        function yt(t, e, i) {
            var n = e.dir, o = e.next, r = o || n, s = i && "parentNode" === r, a = k++;
            return e.first ? function (e, i, o) {
                ...
                } else for (; e = e[n];) if (1 === e.nodeType || s) if (d = (u = e[w] || (e[w] = {}))[e.uniqueID] || (u[e.uniqueID] = {}), o && o === e.nodeName.toLowerCase()) e = e[n] || e; else {
                    if ((c = d[r]) && c[0] === T && c[1] === a) return p[2] = c[2];
                    if (d[r] = p, p[2] = t(e, i, l)) return !0
                }
                return !1
            }
        }
        ...
        function xt(t, e, i, n, o, r) {
            return n && !n[w] && (n = xt(n)), o && !o[w] && (o = xt(o, r)), at((function (r, s, a, l) {
                var c, d, u, p = [], f = [], h = s.length, v = r || function (t, e, i) {
                        for (var n = 0, o = e.length; n < o; n++) rt(t, e[n], i);
                        return i
                    }(e || "*", a.nodeType ? [a] : a, []), g = !t || !r && e ? v : wt(v, p, t, a, l),
                    m = i ? o || (r ? t : h || n) ? [] : s : g;
                if (i && i(g, m, a, l), n) for (c = wt(m, f), n(c, [], a, l), d = c.length; d--;) (u = c[d]) && (m[f[d]] = !(g[f[d]] = u));
                if (r) {
                    if (o || t) {
                        if (o) {
                ...
                } else m = wt(m === s ? m.splice(h, m.length) : m), o ? o(null, s, m, l) : N.apply(s, m)
            }))
        }

        function Tt(t) {
            for (var e, i, o, r = t.length, s = n.relative[t[0].type], a = s || n.relative[" "], l = s ? 1 : 0, d = yt((function (t) {
                return t === e
            }), a, !0), u = yt((function (t) {
                return P(e, t) > -1
                ...
                return e = null, o
            }]; l < r; l++) if (i = n.relative[t[l].type]) p = [yt(bt(p), i)]; else {
                if ((i = n.filter[t[l].type].apply(null, t[l].matches))[w]) {
                    for (o = ++l; o < r && !n.relative[t[o].type]; o++) ;
                    return xt(l > 1 && bt(p), l > 1 && mt(t.slice(0, l - 1).concat({value: " " === t[l - 2].type ? "*" : ""})).replace(W, "$1"), i, l < o && Tt(t.slice(l, o)), o < r && Tt(t = t.slice(o)), o < r && mt(t))
                }
                p.push(i)
            }
            return bt(p)
        ...
        return gt.prototype = n.filters = n.pseudos, n.setFilters = new gt, s = rt.tokenize = function (t, e) {
            ...
            if (!a) {
                ...
                (a = S(t, function (t, e) {
                    var i = e.length > 0, o = t.length > 0, r = function (r, s, a, l, d) {
                        var u, h, g, m = 0, y = "0", b = r && [], w = [], x = c, k = r || o && n.find.TAG("*", d),
                            $ = T += null == x ? 1 : Math.random() || .1, C = k.length;
                        for (d && (c = s === f || s || d); y !== C && null != (u = k[y]); y++) {
                            if (o && u) {
                                for (h = 0, s || u.ownerDocument === f || (p(u), a = !v); g = t[h++];) if (g(u, s || f, a)) {
                                    l.push(u);
                                    break
                                }
                                d && (T = $)
                            }
                            i && ((u = !g && u) && m--, r && b.push(u))
                        }
                        if (m += y, i && y !== m) {
                            for (h = 0; g = e[h++];) g(b, w, s, a);
                            if (r) {
                                if (m > 0) for (; y--;) b[y] || w[y] || (w[y] = j.call(l));
                                w = wt(w)
                            }
                            N.apply(l, w), d && !r && w.length > 0 && m + e.length > 1 && rt.uniqueSort(l)
                        }
                        return d && (T = $, c = x), b
                    };
                    return i ? at(r) : r
            ...
            var r, l, c, d, u, p = "function" == typeof t && t, f = !o && s(t = p.selector || t);
            if (i = i || [], 1 === f.length) {
                ...
                for (r = V.needsContext.test(t) ? 0 : l.length; r-- && (c = l[r], !n.relative[d = c.type]);) if ((u = n.find[d]) && (o = u(c.matches[0].replace(Z, tt), K.test(l[0].type) && vt(e.parentNode) || e))) {
                    if (l.splice(r, 1), !(t = o.length && mt(l))) return N.apply(i, o), i;
                    break
                }
            }
            return (p || a(t, f))(o, e, !v, i, !e || K.test(t) && vt(e.parentNode) || e), i
        }, i.sortStable = w.split("").sort(E).join("") === w, i.detectDuplicates = !!u, p(), i.sortDetached = lt((function (t) {
    ...
    g.filter = function (t, e, i) {
        ...
        find: function (t) {
            ...
            if ("string" != typeof t) return this.pushStack(g(t).filter((function () {
                for (e = 0; e < n; e++) if (g.contains(o[e], this)) return !0
            })));
            ...
            return !!D(this, "string" == typeof t && C.test(t) ? g(t) : t || [], !1).length
        }
    });
    var j, O = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    (g.fn.init = function (t, e, i) {
        ...
        if (i = i || j, "string" == typeof t) {
            ...
            if (o[1]) {
                if (e = e instanceof g ? e[0] : e, g.merge(this, g.parseHTML(o[1], e && e.nodeType ? e.ownerDocument || e : n, !0)), E.test(o[1]) && g.isPlainObject(e)) for (o in e) g.isFunction(this[o]) ? this[o](e[o]) : this.attr(o, e[o]);
                return this
            }
    ...
    g.fn.extend({
        has: function (t) {
            var e = g(t, this), i = e.length;
            return this.filter((function () {
                for (var t = 0; t < i; t++) if (g.contains(this, e[t])) return !0
            }))
        }, closest: function (t, e) {
            var i, n = 0, o = this.length, r = [], s = "string" != typeof t && g(t);
            if (!C.test(t)) for (; n < o; n++) for (i = this[n]; i && i !== e; i = i.parentNode) if (i.nodeType < 11 && (s ? s.index(i) > -1 : 1 === i.nodeType && g.find.matchesSelector(i, t))) {
                r.push(i);
                break
            }
        ...
        g.fn[t] = function (i, n) {
            ...
            return "Until" !== t.slice(-5) && (n = i), n && "string" == typeof n && (o = g.filter(n, o)), this.length > 1 && (L[t] || g.uniqueSort(o), N.test(t) && o.reverse()), this.pushStack(o)
        }
    }));
    var I = /[^\x20\t\r\n\f]+/g;
    ...
    g.Callbacks = function (t) {
            ...
            add: function () {
                return r && (i && !e && (a = r.length - 1, s.push(i)), function e(i) {
                    g.each(i, (function (i, n) {
                        g.isFunction(n) ? t.unique && c.has(n) || r.push(n) : n && n.length && "string" !== g.type(n) && e(n)
                    }))
                }(arguments), i && !e && l()), this
            }, remove: function () {
                return g.each(arguments, (function (t, e) {
                    for (var i; (i = g.inArray(e, r, i)) > -1;) r.splice(i, 1), i <= a && a--
                })), this
            }, has: function (t) {
        ...
        Deferred: function (e) {
                ...
                n = "pending", o = {
                    state: function () {
                            ...
                            return function () {
                                var a = this, l = arguments, c = function () {
                                    ...
                                    if (!(e < r)) {
                                        ...
                                        c = t && ("object" == typeof t || "function" == typeof t) && t.then, g.isFunction(c) ? o ? c.call(t, s(r, i, H, o), s(r, i, q, o)) : (r++, c.call(t, s(r, i, H, o), s(r, i, q, o), s(r, i, H, i.notifyWith))) : (n !== H && (a = void 0, l = [t]), (o || i.resolveWith)(a, l))
                                    }
                                }, d = o ? c : function () {
                                    try {
                                        c()
                                    } catch (t) {
                                        g.Deferred.exceptionHook && g.Deferred.exceptionHook(t, d.stackTrace), e + 1 >= r && (n !== q && (a = void 0, l = [t]), i.rejectWith(a, l))
                                    }
                                };
                        ...
                        return g.Deferred((function (t) {
                            i[0][3].add(s(0, t, g.isFunction(o) ? o : H, t.notifyWith)), i[1][3].add(s(0, t, g.isFunction(e) ? e : H)), i[2][3].add(s(0, t, g.isFunction(n) ? n : q))
                        })).promise()
                    }, promise: function (t) {
            ...
            var e = arguments.length, i = e, n = Array(i), o = r.call(arguments), s = g.Deferred(), a = function (t) {
                return function (i) {
                    n[t] = this, o[t] = arguments.length > 1 ? r.call(arguments) : i, --e || s.resolveWith(n, o)
                }
            };
            if (e <= 1 && (M(t, s.done(a(i)).resolve, s.reject, !e), "pending" === s.state() || g.isFunction(o[i] && o[i].then))) return s.then();
    ...
    var z = function (t, e, i, n, o, r, s) {
        ...
        if ("object" === g.type(i)) for (a in o = !0, i) z(t, e, a, i[a], !0, r, s); else if (void 0 !== n && (o = !0, g.isFunction(n) || (s = !0), c && (s ? (e.call(t, n), e = null) : (c = e, e = function (t, e, i) {
            return c.call(g(t), i)
    ...
    U.uid = 1, U.prototype = {
        cache: function (t) {
            ...
            if ("string" == typeof e) o[g.camelCase(e)] = i; else for (n in e) o[g.camelCase(n)] = e[n];
            return o
        }, get: function (t, e) {
            ...
            if (void 0 !== n) {
                if (void 0 !== e) {
                    i = (e = Array.isArray(e) ? e.map(g.camelCase) : (e = g.camelCase(e)) in n ? [e] : e.match(I) || []).length;
                    for (; i--;) delete n[e[i]]
                }
    ...
    var B = new U, X = new U, V = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, Y = /[A-Z]/g;

    function Q(t, e, i) {
        var n;
        if (void 0 === i && 1 === t.nodeType) if (n = "data-" + e.replace(Y, "-$&").toLowerCase(), "string" == typeof (i = t.getAttribute(n))) {
            try {
                i = function (t) {
    ...
    g.extend({
        hasData: function (t) {
            return X.hasData(t) || B.hasData(t)
        }, data: function (t, e, i) {
        ...
        data: function (t, e) {
            ...
            if (void 0 === t) {
                if (this.length && (o = X.get(r), 1 === r.nodeType && !B.get(r, "hasDataAttrs"))) {
                    for (i = s.length; i--;) s[i] && 0 === (n = s[i].name).indexOf("data-") && (n = g.camelCase(n.slice(5)), Q(r, n, o[n]));
            ...
            return "object" == typeof t ? this.each((function () {
                ...
                var i;
                if (r && void 0 === e) return void 0 !== (i = X.get(r, t)) || void 0 !== (i = Q(r, t)) ? i : void 0;
                this.each((function () {
                    X.set(this, t, e)
                }))
        ...
        queue: function (t, e, i) {
            var n;
            if (t) return e = (e || "fx") + "queue", n = B.get(t, e), i && (!n || Array.isArray(i) ? n = B.access(t, e, g.makeArray(i)) : n.push(i)), n || []
        }, dequeue: function (t, e) {
            e = e || "fx";
            var i = g.queue(t, e), n = i.length, o = i.shift(), r = g._queueHooks(t, e);
        ...
        queue: function (t, e) {
            ...
            for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; s--;) (i = B.get(r[s], t + "queueHooks")) && i.empty && (n++, i.empty.add(a));
            return a(), o.promise(e)
        }
    });
    var G = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, J = new RegExp("^(?:([+-])=|)(" + G + ")([a-z%]*)$", "i"),
        K = ["Top", "Right", "Bottom", "Left"], Z = function (t, e) {
    ...
    function et(t, e, i, n) {
        var o, r = 1, s = 20, a = n ? function () {
                ...
                return g.css(t, e, "")
            }, l = a(), c = i && i[3] || (g.cssNumber[e] ? "" : "px"),
            d = (g.cssNumber[e] || "px" !== c && +l) && J.exec(g.css(t, e));
        if (d && d[3] !== c) {
            c = c || d[3], i = i || [], d = +l || 1;
            do {
                d /= r = r || ".5", g.style(t, e, d + c)
            } while (r !== (r = a() / l) && 1 !== r && --s)
        }
    ...
    function nt(t) {
        var e, i = t.ownerDocument, n = t.nodeName, o = it[n];
        return o || (e = i.body.appendChild(i.createElement(n)), o = g.css(e, "display"), e.parentNode.removeChild(e), "none" === o && (o = "block"), it[n] = o, o)
    }

    function ot(t, e) {
        for (var i, n, o = [], r = 0, s = t.length; r < s; r++) (n = t[r]).style && (i = n.style.display, e ? ("none" === i && (o[r] = B.get(n, "display") || null, o[r] || (n.style.display = "")), "" === n.style.display && Z(n) && (o[r] = nt(n))) : "none" !== i && (o[r] = "none", B.set(n, "display", i)));
    ...
    function ct(t, e) {
        var i;
        return i = void 0 !== t.getElementsByTagName ? t.getElementsByTagName(e || "*") : void 0 !== t.querySelectorAll ? t.querySelectorAll(e || "*") : [], void 0 === e || e && S(t, e) ? g.merge([t], i) : i
    }
    ...
    function ht(t, e, i, n, o) {
        for (var r, s, a, l, c, d, u = e.createDocumentFragment(), p = [], f = 0, h = t.length; f < h; f++) if ((r = t[f]) || 0 === r) if ("object" === g.type(r)) g.merge(p, r.nodeType ? [r] : r); else if (ft.test(r)) {
            for (s = s || u.appendChild(e.createElement("div")), a = (st.exec(r) || ["", ""])[1].toLowerCase(), l = lt[a] || lt._default, s.innerHTML = l[1] + g.htmlPrefilter(r) + l[2], d = l[0]; d--;) s = s.lastChild;
            g.merge(p, s.childNodes), (s = u.firstChild).textContent = ""
        } else p.push(e.createTextNode(r));
        for (u.textContent = "", f = 0; r = p[f++];) if (n && g.inArray(r, n) > -1) o && o.push(r); else if (c = g.contains(r.ownerDocument, r), s = ct(u.appendChild(r), "script"), c && dt(s), i) for (d = 0; r = s[d++];) at.test(r.type || "") && i.push(r);
        return u
    }

    ut = n.createDocumentFragment().appendChild(n.createElement("div")), (pt = n.createElement("input")).setAttribute("type", "radio"), pt.setAttribute("checked", "checked"), pt.setAttribute("name", "t"), ut.appendChild(pt), h.checkClone = ut.cloneNode(!0).cloneNode(!0).lastChild.checked, ut.innerHTML = "<textarea>x</textarea>", h.noCloneChecked = !!ut.cloneNode(!0).lastChild.defaultValue;
    var vt = n.documentElement, gt = /^key/, mt = /^(?:mouse|pointer|contextmenu|drag|drop)|click/,
        yt = /^([^.]*)(?:\.(.+)|)/;
    ...
    g.event = {
        global: {}, add: function (t, e, i, n, o) {
            var r, s, a, l, c, d, u, p, f, h, v, m = B.get(t);
            if (m) for (i.handler && (i = (r = i).handler, o = r.selector), o && g.find.matchesSelector(vt, o), i.guid || (i.guid = g.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function (e) {
                return void 0 !== g && g.event.triggered !== e.type ? g.event.dispatch.apply(t, arguments) : void 0
            }), c = (e = (e || "").match(I) || [""]).length; c--;) f = v = (a = yt.exec(e[c]) || [])[1], h = (a[2] || "").split(".").sort(), f && (u = g.event.special[f] || {}, f = (o ? u.delegateType : u.bindType) || f, u = g.event.special[f] || {}, d = g.extend({
                type: f,
                origType: v,
                data: n,
                handler: i,
                ...
                namespace: h.join(".")
            }, r), (p = l[f]) || ((p = l[f] = []).delegateCount = 0, u.setup && !1 !== u.setup.call(t, n, h, s) || t.addEventListener && t.addEventListener(f, s)), u.add && (u.add.call(t, d), d.handler.guid || (d.handler.guid = i.guid)), o ? p.splice(p.delegateCount++, 0, d) : p.push(d), g.event.global[f] = !0)
        }, remove: function (t, e, i, n, o) {
            var r, s, a, l, c, d, u, p, f, h, v, m = B.hasData(t) && B.get(t);
            if (m && (l = m.events)) {
                for (c = (e = (e || "").match(I) || [""]).length; c--;) if (f = v = (a = yt.exec(e[c]) || [])[1], h = (a[2] || "").split(".").sort(), f) {
                    for (u = g.event.special[f] || {}, p = l[f = (n ? u.delegateType : u.bindType) || f] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = p.length; r--;) d = p[r], !o && v !== d.origType || i && i.guid !== d.guid || a && !a.test(d.namespace) || n && n !== d.selector && ("**" !== n || !d.selector) || (p.splice(r, 1), d.selector && p.delegateCount--, u.remove && u.remove.call(t, d));
                    s && !p.length && (u.teardown && !1 !== u.teardown.call(t, h, m.handle) || g.removeEvent(t, f, m.handle), delete l[f])
                } else for (f in l) g.event.remove(t, f + e[c], i, n, !0);
                g.isEmptyObject(l) && B.remove(t, "handle events")
            }
        }, dispatch: function (t) {
            var e, i, n, o, r, s, a = g.event.fix(t), l = new Array(arguments.length),
                c = (B.get(this, "events") || {})[a.type] || [], d = g.event.special[a.type] || {};
    ...
    var kt = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi,
        $t = /<script|<style|<link/i, Ct = /checked\s*(?:[^=]|=\s*.checked.)/i, St = /^true\/(.*)/,
        Et = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
    ...
    function Ot(t, e) {
        var i, n, o, r, s, a, l, c;
        if (1 === e.nodeType) {
            if (B.hasData(t) && (r = B.access(t), s = B.set(e, r), c = r.events)) for (o in delete s.handle, s.events = {}, c) for (i = 0, n = c[o].length; i < n; i++) g.event.add(e, o, c[o][i]);
            X.hasData(t) && (a = X.access(t), l = g.extend({}, a), X.set(e, l))
        }
    }

    function Nt(t, e, i, n) {
        e = s.apply([], e);
        var o, r, a, l, c, d, u = 0, p = t.length, f = p - 1, m = e[0], y = g.isFunction(m);
        if (y || p > 1 && "string" == typeof m && !h.checkClone && Ct.test(m)) return t.each((function (o) {
            var r = t.eq(o);
            y && (e[0] = m.call(this, o, r.html())), Nt(r, e, i, n)
        }));
        if (p && (r = (o = ht(e, t[0].ownerDocument, !1, t, n)).firstChild, 1 === o.childNodes.length && (o = r), r || n)) {
            for (l = (a = g.map(ct(o, "script"), Dt)).length; u < p; u++) c = o, u !== f && (c = g.clone(c, !0, !0), l && g.merge(a, ct(c, "script"))), i.call(t[u], c, u);
            if (l) for (d = a[a.length - 1].ownerDocument, g.map(a, jt), u = 0; u < l; u++) c = a[u], at.test(c.type || "") && !B.access(c, "globalEval") && g.contains(d, c) && (c.src ? g._evalUrl && g._evalUrl(c.src) : v(c.textContent.replace(Et, ""), d))
        }
        return t
    }

    function Lt(t, e, i) {
        for (var n, o = e ? g.filter(e, t) : t, r = 0; null != (n = o[r]); r++) i || 1 !== n.nodeType || g.cleanData(ct(n)), n.parentNode && (i && g.contains(n.ownerDocument, n) && dt(ct(n, "script")), n.parentNode.removeChild(n));
        return t
    }
    ...
    g.extend({
        htmlPrefilter: function (t) {
            ...
            var n, o, r, s, a, l, c, d = t.cloneNode(!0), u = g.contains(t.ownerDocument, t);
            if (!(h.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || g.isXMLDoc(t))) for (s = ct(d), n = 0, o = (r = ct(t)).length; n < o; n++) a = r[n], "input" === (c = (l = s[n]).nodeName.toLowerCase()) && rt.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
            if (e) if (i) for (r = r || ct(t), s = s || ct(d), n = 0, o = r.length; n < o; n++) Ot(r[n], s[n]); else Ot(t, d);
            return (s = ct(d, "script")).length > 0 && dt(s, !u && ct(t, "script")), d
        }, cleanData: function (t) {
            for (var e, i, n, o = g.event.special, r = 0; void 0 !== (i = t[r]); r++) if (_(i)) {
                if (e = i[B.expando]) {
                    if (e.events) for (n in e.events) o[n] ? g.event.remove(i, n) : g.removeEvent(i, n, e.handle);
                    i[B.expando] = void 0
                }
        ...
        detach: function (t) {
            ...
            return z(this, (function (t) {
                ...
                if ("string" == typeof t && !$t.test(t) && !lt[(st.exec(t) || ["", ""])[1].toLowerCase()]) {
                    t = g.htmlPrefilter(t);
                    try {
    ...
    var Pt = /^margin/, It = new RegExp("^(" + G + ")(?!px)[a-z%]+$", "i"), Ht = function (e) {
    ...
    function qt(t, e, i) {
        ...
        return (i = i || Ht(t)) && ("" !== (s = i.getPropertyValue(e) || i[e]) || g.contains(t.ownerDocument, t) || (s = g.style(t, e)), !h.pixelMarginRight() && It.test(s) && Pt.test(e) && (n = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = i.width, a.width = n, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
    }
    ...
    var Rt = /^(none|table(?!-c[ea]).+)/, Ft = /^--/,
        Wt = {position: "absolute", visibility: "hidden", display: "block"},
        zt = {letterSpacing: "0", fontWeight: "400"}, _t = ["Webkit", "Moz", "ms"], Ut = n.createElement("div").style;

    function Bt(t) {
        var e = g.cssProps[t];
        return e || (e = g.cssProps[t] = function (t) {
            if (t in Ut) return t;
            for (var e = t[0].toUpperCase() + t.slice(1), i = _t.length; i--;) if ((t = _t[i] + e) in Ut) return t
        }(t) || t), e
    }
    ...
    function Vt(t, e, i, n, o) {
        var r, s = 0;
        for (r = i === (n ? "border" : "content") ? 4 : "width" === e ? 1 : 0; r < 4; r += 2) "margin" === i && (s += g.css(t, i + K[r], !0, o)), n ? ("content" === i && (s -= g.css(t, "padding" + K[r], !0, o)), "margin" !== i && (s -= g.css(t, "border" + K[r] + "Width", !0, o))) : (s += g.css(t, "padding" + K[r], !0, o), "padding" !== i && (s += g.css(t, "border" + K[r] + "Width", !0, o)));
        return s
    }

    function Yt(t, e, i) {
        var n, o = Ht(t), r = qt(t, e, o), s = "border-box" === g.css(t, "boxSizing", !1, o);
        return It.test(r) ? r : (n = s && (h.boxSizingReliable() || r === t.style[e]), "auto" === r && (r = t["offset" + e[0].toUpperCase() + e.slice(1)]), (r = parseFloat(r) || 0) + Vt(t, e, i || (s ? "border" : "content"), n, o) + "px")
    }
    ...
    g.extend({
        ...
        style: function (t, e, i, n) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var o, r, s, a = g.camelCase(e), l = Ft.test(e), c = t.style;
                if (l || (e = Bt(a)), s = g.cssHooks[e] || g.cssHooks[a], void 0 === i) return s && "get" in s && void 0 !== (o = s.get(t, !1, n)) ? o : c[e];
                "string" == (r = typeof i) && (o = J.exec(i)) && o[1] && (i = et(t, e, o), r = "number"), null != i && i == i && ("number" === r && (i += o && o[3] || (g.cssNumber[a] ? "" : "px")), h.clearCloneStyle || "" !== i || 0 !== e.indexOf("background") || (c[e] = "inherit"), s && "set" in s && void 0 === (i = s.set(t, i, n)) || (l ? c.setProperty(e, i) : c[e] = i))
            }
        },
        css: function (t, e, i, n) {
            var o, r, s, a = g.camelCase(e);
            return Ft.test(e) || (e = Bt(a)), (s = g.cssHooks[e] || g.cssHooks[a]) && "get" in s && (o = s.get(t, !0, i)), void 0 === o && (o = qt(t, e, n)), "normal" === o && e in zt && (o = zt[e]), "" === i || i ? (r = parseFloat(o), !0 === i || isFinite(r) ? r || 0 : o) : o
        }
    }), g.each(["height", "width"], (function (t, e) {
        g.cssHooks[e] = {
            get: function (t, i, n) {
                if (i) return !Rt.test(g.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? Yt(t, e, n) : tt(t, Wt, (function () {
                    return Yt(t, e, n)
                }))
            }, set: function (t, i, n) {
                var o, r = n && Ht(t), s = n && Vt(t, e, n, "border-box" === g.css(t, "boxSizing", !1, r), r);
                return s && (o = J.exec(i)) && "px" !== (o[3] || "px") && (t.style[e] = i, i = g.css(t, e)), Xt(0, i, s)
            }
        }
    })), g.cssHooks.marginLeft = Mt(h.reliableMarginLeft, (function (t, e) {
        if (e) return (parseFloat(qt(t, "marginLeft")) || t.getBoundingClientRect().left - tt(t, {marginLeft: 0}, (function () {
            return t.getBoundingClientRect().left
        }))) + "px"
    })), g.each({margin: "", padding: "", border: "Width"}, (function (t, e) {
        g.cssHooks[t + e] = {
            expand: function (i) {
                for (var n = 0, o = {}, r = "string" == typeof i ? i.split(" ") : [i]; n < 4; n++) o[t + K[n] + e] = r[n] || r[n - 2] || r[0];
                return o
            }
        }, Pt.test(t) || (g.cssHooks[t + e].set = Xt)
    })), g.fn.extend({
        css: function (t, e) {
            return z(this, (function (t, e, i) {
                var n, o, r = {}, s = 0;
                if (Array.isArray(e)) {
                    for (n = Ht(t), o = e.length; s < o; s++) r[e[s]] = g.css(t, e[s], !1, n);
                    return r
                }
                return void 0 !== i ? g.style(t, e, i) : g.css(t, e)
            }), t, e, arguments.length > 1)
        }
    }), g.Tween = Qt, Qt.prototype = {
        constructor: Qt, init: function (t, e, i, n, o, r) {
            ...
            return this.options.duration ? this.pos = e = g.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration) : this.pos = e = t, this.now = (this.end - this.start) * e + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), i && i.set ? i.set(this) : Qt.propHooks._default.set(this), this
        }
    ...
    }, g.fx = Qt.prototype.init, g.fx.step = {};
    var Gt, Jt, Kt = /^(?:toggle|show|hide)$/, Zt = /queueHooks$/;

    function te() {
        Jt && (!1 === n.hidden && t.requestAnimationFrame ? t.requestAnimationFrame(te) : t.setTimeout(te, g.fx.interval), g.fx.tick())
    }
    ...
    function ie(t, e) {
        ...
        for (e = e ? 1 : 0; n < 4; n += 2 - e) o["margin" + (i = K[n])] = o["padding" + i] = t;
        return e && (o.opacity = o.width = t), o
    }

    function ne(t, e, i) {
        for (var n, o = (oe.tweeners[e] || []).concat(oe.tweeners["*"]), r = 0, s = o.length; r < s; r++) if (n = o[r].call(i, e, t)) return n
    }

    function oe(t, e, i) {
        var n, o, r = 0, s = oe.prefilters.length, a = g.Deferred().always((function () {
            delete l.elem
        })), l = function () {
            if (o) return !1;
        ...
        for (function (t, e) {
            var i, n, o, r, s;
            for (i in t) if (o = e[n = g.camelCase(i)], r = t[i], Array.isArray(r) && (o = r[1], r = t[i] = r[0]), i !== n && (t[n] = r, delete t[i]), (s = g.cssHooks[n]) && "expand" in s) for (i in r = s.expand(r), delete t[n], r) i in t || (t[i] = r[i], e[i] = o); else e[n] = o
        }(d, c.opts.specialEasing); r < s; r++) if (n = oe.prefilters[r].call(c, t, d, c.opts)) return g.isFunction(n.stop) && (g._queueHooks(c.elem, c.opts.queue).stop = g.proxy(n.stop, n)), n;
        return g.map(d, ne, c), g.isFunction(c.opts.start) && c.opts.start.call(t, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), g.fx.timer(g.extend(l, {
            elem: t,
            anim: c,
            queue: c.opts.queue
        })), c
    ...
    g.Animation = g.extend(oe, {
        tweeners: {
            ...
            var n, o, r, s, a, l, c, d, u = "width" in e || "height" in e, p = this, f = {}, h = t.style,
                v = t.nodeType && Z(t), m = B.get(t, "fxshow");
            ...
            if ((l = !g.isEmptyObject(e)) || !g.isEmptyObject(f)) for (n in u && 1 === t.nodeType && (i.overflow = [h.overflow, h.overflowX, h.overflowY], null == (c = m && m.display) && (c = B.get(t, "display")), "none" === (d = g.css(t, "display")) && (c ? d = c : (ot([t], !0), c = t.style.display || c, d = g.css(t, "display"), ot([t]))), ("inline" === d || "inline-block" === d && null != c) && "none" === g.css(t, "float") && (l || (p.done((function () {
                h.display = c
            })), null == c && (d = h.display, c = "none" === d ? "" : d)), h.display = "inline-block")), i.overflow && (h.overflow = "hidden", p.always((function () {
                h.overflow = i.overflow[0], h.overflowX = i.overflow[1], h.overflowY = i.overflow[2]
            }))), l = !1, f) l || (m ? "hidden" in m && (v = m.hidden) : m = B.access(t, "fxshow", {display: c}), r && (m.hidden = !v), v && ot([t], !0), p.done((function () {
                for (n in v || ot([t]), B.remove(t, "fxshow"), f) g.style(t, n, f[n])
        ...
        fadeTo: function (t, e, i, n) {
            ...
            var o = g.isEmptyObject(t), r = g.speed(e, i, n), s = function () {
            ...
            return "string" != typeof t && (i = e, e = t, t = void 0), e && !1 !== t && this.queue(t || "fx", []), this.each((function () {
                var e = !0, o = null != t && t + "queueHooks", r = g.timers, s = B.get(this);
                if (o) s[o] && s[o].stop && n(s[o]); else for (o in s) s[o] && s[o].stop && Zt.test(o) && n(s[o]);
                for (o = r.length; o--;) r[o].elem !== this || null != t && r[o].queue !== t || (r[o].anim.stop(i), e = !1, r.splice(o, 1));
                !e && i || g.dequeue(this, t)
            }))
        }, finish: function (t) {
            return !1 !== t && (t = t || "fx"), this.each((function () {
                var e, i = B.get(this), n = i[t + "queue"], o = i[t + "queueHooks"], r = g.timers, s = n ? n.length : 0;
        ...
        Jt = null
    }, g.fx.speeds = {slow: 600, fast: 200, _default: 400}, g.fn.delay = function (e, i) {
    ...
    g.fn.extend({
        ...
        addClass: function (t) {
            ...
            return "boolean" == typeof e && "string" === i ? e ? this.addClass(t) : this.removeClass(t) : g.isFunction(t) ? this.each((function (i) {
                ...
                var e, n, o, r;
                if ("string" === i) for (n = 0, o = g(this), r = t.match(I) || []; e = r[n++];) o.hasClass(e) ? o.removeClass(e) : o.addClass(e); else void 0 !== t && "boolean" !== i || ((e = de(this)) && B.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === t ? "" : B.get(this, "__className__") || ""))
            }))
        }, hasClass: function (t) {
            var e, i, n = 0;
    ...
    g.fn.extend({
        val: function (t) {
            ...
            }))) : o ? (e = g.valHooks[o.type] || g.valHooks[o.nodeName.toLowerCase()]) && "get" in e && void 0 !== (i = e.get(o, "value")) ? i : "string" == typeof (i = o.value) ? i.replace(ue, "") : null == i ? "" : i : void 0
        }
    }), g.extend({
        valHooks: {
            option: {
                ...
                get: function (t) {
                    var e, i, n, o = t.options, r = t.selectedIndex, s = "select-one" === t.type, a = s ? null : [],
                        l = s ? r + 1 : o.length;
                    for (n = r < 0 ? l : s ? r : 0; n < l; n++) if (((i = o[n]).selected || n === r) && !i.disabled && (!i.parentNode.disabled || !S(i.parentNode, "optgroup"))) {
    ...
    g.extend(g.event, {
        trigger: function (e, i, o, r) {
            var s, a, l, c, d, p, f, h = [o || n], v = u.call(e, "type") ? e.type : e,
                m = u.call(e, "namespace") ? e.namespace.split(".") : [];
            if (a = l = o = o || n, 3 !== o.nodeType && 8 !== o.nodeType && !pe.test(v + g.event.triggered) && (v.indexOf(".") > -1 && (m = v.split("."), v = m.shift(), m.sort()), d = v.indexOf(":") < 0 && "on" + v, (e = e[g.expando] ? e : new g.Event(v, "object" == typeof e && e)).isTrigger = r ? 2 : 3, e.namespace = m.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + m.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = o), i = null == i ? [e] : g.makeArray(i, [e]), f = g.event.special[v] || {}, r || !f.trigger || !1 !== f.trigger.apply(o, i))) {
                ...
                for (s = 0; (a = h[s++]) && !e.isPropagationStopped();) e.type = s > 1 ? c : f.bindType || v, (p = (B.get(a, "events") || {})[e.type] && B.get(a, "handle")) && p.apply(a, i), (p = d && a[d]) && p.apply && _(a) && (e.result = p.apply(a, i), !1 === e.result && e.preventDefault());
                return e.type = v, r || e.isDefaultPrevented() || f._default && !1 !== f._default.apply(h.pop(), i) || !_(o) || d && g.isFunction(o[v]) && !g.isWindow(o) && ((l = o[d]) && (o[d] = null), g.event.triggered = v, o[v](), g.event.triggered = void 0, l && (o[d] = l)), e.result
            }
        }, simulate: function (t, e, i) {
            var n = g.extend(new g.Event, i, {type: t, isSimulated: !0});
    ...
    }), h.focusin = "onfocusin" in t, h.focusin || g.each({focus: "focusin", blur: "focusout"}, (function (t, e) {
        var i = function (t) {
            g.event.simulate(e, t.target, g.event.fix(t))
        };
        g.event.special[e] = {
            setup: function () {
                var n = this.ownerDocument || this, o = B.access(n, e);
                o || n.addEventListener(t, i, !0), B.access(n, e, (o || 0) + 1)
            }, teardown: function () {
                var n = this.ownerDocument || this, o = B.access(n, e) - 1;
                o ? B.access(n, e, o) : (n.removeEventListener(t, i, !0), B.remove(n, e))
            }
        }
    }));
    var fe = t.location, he = g.now(), ve = /\?/;
    ...
    function we(t, e, i, n) {
        ...
        })); else if (i || "object" !== g.type(e)) n(t, e); else for (o in e) we(t + "[" + o + "]", e[o], i, n)
    }
    ...
    var xe = /%20/g, Te = /#.*$/, ke = /([?&])_=[^&]*/, $e = /^(.*?):[ \t]*([^\r\n]*)$/gm, Ce = /^(?:GET|HEAD)$/,
        Se = /^\/\//, Ee = {}, Ae = {}, De = "*/".concat("*"), je = n.createElement("a");

    function Oe(t) {
        return function (e, i) {
            "string" != typeof e && (i = e, e = "*");
            var n, o = 0, r = e.toLowerCase().match(I) || [];
            if (g.isFunction(i)) for (; n = r[o++];) "+" === n[0] ? (n = n.slice(1) || "*", (t[n] = t[n] || []).unshift(i)) : (t[n] = t[n] || []).push(i)
        }
    }
    ...
    je.href = fe.href, g.extend({
        ...
        ajaxSettings: {
            ...
            converters: {"* text": String, "text html": !0, "text json": JSON.parse, "text xml": g.parseXML},
        ...
        ajax: function (e, i) {
            ...
            var o, r, s, a, l, c, d, u, p, f, h = g.ajaxSetup({}, i), v = h.context || h,
                m = h.context && (v.nodeType || v.jquery) ? g(v) : g.event, y = g.Deferred(),
                b = g.Callbacks("once memory"), w = h.statusCode || {}, x = {}, T = {}, k = "canceled", $ = {
                    readyState: 0, getResponseHeader: function (t) {
                        ...
                        return null == d && (t = T[t.toLowerCase()] = T[t.toLowerCase()] || t, x[t] = e), this
                    }, overrideMimeType: function (t) {
                        return null == d && (h.mimeType = t), this
                    }, statusCode: function (t) {
                        var e;
                        if (t) if (d) $.always(t[$.status]); else for (e in t) w[e] = [w[e], t[e]];
                        return this
                    }, abort: function (t) {
                        var e = t || k;
            ...
            if (y.promise($), h.url = ((e || h.url || fe.href) + "").replace(Se, fe.protocol + "//"), h.type = i.method || i.type || h.method || h.type, h.dataTypes = (h.dataType || "*").toLowerCase().match(I) || [""], null == h.crossDomain) {
                c = n.createElement("a");
                try {
            ...
            if (h.data && h.processData && "string" != typeof h.data && (h.data = g.param(h.data, h.traditional)), Ne(Ee, h, i, $), d) return $;
            for (p in (u = g.event && h.global) && 0 == g.active++ && g.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !Ce.test(h.type), r = h.url.replace(Te, ""), h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(xe, "+")) : (f = h.url.slice(r.length), h.data && (r += (ve.test(r) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (r = r.replace(ke, "$1"), f = (ve.test(r) ? "&" : "?") + "_=" + he++ + f), h.url = r + f), h.ifModified && (g.lastModified[r] && $.setRequestHeader("If-Modified-Since", g.lastModified[r]), g.etag[r] && $.setRequestHeader("If-None-Match", g.etag[r])), (h.data && h.hasContent && !1 !== h.contentType || i.contentType) && $.setRequestHeader("Content-Type", h.contentType), $.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + De + "; q=0.01" : "") : h.accepts["*"]), h.headers) $.setRequestHeader(p, h.headers[p]);
            if (h.beforeSend && (!1 === h.beforeSend.call(v, $, h) || d)) return $.abort();
            if (k = "abort", b.add(h.complete), $.done(h.success), $.fail(h.error), o = Ne(Ae, h, i, $)) {
            ...
            function C(e, i, n, a) {
                var c, p, f, x, T, k = i;
                d || (d = !0, l && t.clearTimeout(l), o = void 0, s = a || "", $.readyState = e > 0 ? 4 : 0, c = e >= 200 && e < 300 || 304 === e, n && (x = function (t, e, i) {
                ...
                }(h, $, n)), x = function (t, e, i, n) {
                    var o, r, s, a, l, c = {}, d = t.dataTypes.slice();
                    if (d[1]) for (s in t.converters) c[s.toLowerCase()] = t.converters[s];
                    for (r = d.shift(); r;) if (t.responseFields[r] && (i[t.responseFields[r]] = e), !l && n && t.dataFilter && (e = t.dataFilter(e, t.dataType)), l = r, r = d.shift()) if ("*" === r) r = l; else if ("*" !== l && l !== r) {
                ...
                }(h, x, $, c), c ? (h.ifModified && ((T = $.getResponseHeader("Last-Modified")) && (g.lastModified[r] = T), (T = $.getResponseHeader("etag")) && (g.etag[r] = T)), 204 === e || "HEAD" === h.type ? k = "nocontent" : 304 === e ? k = "notmodified" : (k = x.state, p = x.data, c = !(f = x.error))) : (f = k, !e && k || (k = "error", e < 0 && (e = 0))), $.status = e, $.statusText = (i || k) + "", c ? y.resolveWith(v, [p, k, $]) : y.rejectWith(v, [$, k, f]), $.statusCode(w), w = void 0, u && m.trigger(c ? "ajaxSuccess" : "ajaxError", [$, h, c ? p : f]), b.fireWith(v, [$, k]), u && (m.trigger("ajaxComplete", [$, h]), --g.active || g.event.trigger("ajaxStop")))
            }
    ...
    var Pe = {0: 200, 1223: 204}, Ie = g.ajaxSettings.xhr();
    h.cors = !!Ie && "withCredentials" in Ie, h.ajax = Ie = !!Ie, g.ajaxTransport((function (e) {
        var i, n;
        if (h.cors || Ie && !e.crossDomain) return {
            send: function (o, r) {
                var s, a = e.xhr();
                ...
                i = function (t) {
                    return function () {
                        i && (i = n = a.onload = a.onerror = a.onabort = a.onreadystatechange = null, "abort" === t ? a.abort() : "error" === t ? "number" != typeof a.status ? r(0, "error") : r(a.status, a.statusText) : r(Pe[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {binary: a.response} : {text: a.responseText}, a.getAllResponseHeaders()))
                    }
        ...
        if (t.crossDomain) return {
            send: function (o, r) {
                e = g("<script>").prop({charset: t.scriptCharset, src: t.url}).on("load error", i = function (t) {
    ...
    g.ajaxSetup({
        ...
        if (a || "jsonp" === e.dataTypes[0]) return o = e.jsonpCallback = g.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Me, "$1" + o) : !1 !== e.jsonp && (e.url += (ve.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function () {
            return s || g.error(o + " was not called"), s[0]
        }, e.dataTypes[0] = "json", r = t[o], t[o] = function () {
            s = arguments
        }, n.always((function () {
            void 0 === r ? g(t).removeProp(o) : t[o] = r, e[o] && (e.jsonpCallback = i.jsonpCallback, qe.push(o)), s && g.isFunction(r) && r(s[0]), s = r = void 0
        })), "script"
    })), h.createHTMLDocument = ((He = n.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === He.childNodes.length), g.parseHTML = function (t, e, i) {
        ...
        setOffset: function (t, e, i) {
            ...
            "static" === c && (t.style.position = "relative"), a = d.offset(), r = g.css(t, "top"), l = g.css(t, "left"), ("absolute" === c || "fixed" === c) && (r + l).indexOf("auto") > -1 ? (s = (n = d.position()).top, o = n.left) : (s = parseFloat(r) || 0, o = parseFloat(l) || 0), g.isFunction(e) && (e = e.call(t, i, g.extend({}, a))), null != e.top && (u.top = e.top - a.top + s), null != e.left && (u.left = e.left - a.left + o), "using" in e ? e.using.call(t, u) : d.css(u)
        }
    }, g.fn.extend({
        offset: function (t) {
            ...
            if (this[0]) {
                ...
                return "fixed" === g.css(i, "position") ? e = i.getBoundingClientRect() : (t = this.offsetParent(), e = this.offset(), S(t[0], "html") || (n = t.offset()), n = {
                    top: n.top + g.css(t[0], "borderTopWidth", !0),
                    left: n.left + g.css(t[0], "borderLeftWidth", !0)
                }), {top: e.top - n.top - g.css(i, "marginTop", !0), left: e.left - n.left - g.css(i, "marginLeft", !0)}
            }
        ...
        g.fn[t] = function (n) {
            return z(this, (function (t, n, o) {
                var r;
                if (g.isWindow(t) ? r = t : 9 === t.nodeType && (r = t.defaultView), void 0 === o) return r ? r[e] : t[n];
                r ? r.scrollTo(i ? r.pageXOffset : o, i ? o : r.pageYOffset) : t[n] = o
            }), t, n, arguments.length)
        }
    })), g.each(["top", "left"], (function (t, e) {
        g.cssHooks[e] = Mt(h.pixelPosition, (function (t, i) {
            if (i) return i = qt(t, e), It.test(i) ? g(t).position()[e] + "px" : i
        }))
    })), g.each({Height: "height", Width: "width"}, (function (t, e) {
        g.each({padding: "inner" + t, content: e, "": "outer" + t}, (function (i, n) {
            g.fn[n] = function (o, r) {
    ...
    }, g.isArray = Array.isArray, g.parseJSON = JSON.parse, g.nodeName = S, "function" == typeof define && define.amd && define("jquery", [], (function () {
        return g
    }));
    var Re = t.jQuery, Fe = t.$;
    ...
    return function (t) {
        ...
        var o = Object.assign || function (t) {
                ...
                return t
            }, r = (n(i(1)), i(6)), s = n(r), a = n(i(7)), l = n(i(8)), c = n(i(9)), d = n(i(10)), u = n(i(11)),
            p = n(i(14)), f = [], h = !1, v = document.all && !window.atob, g = {
                offset: 0,
                delay: 0,
                easing: "ease",
                duration: 400,
                ...
                if (arguments.length > 0 && void 0 !== arguments[0] && arguments[0] && (h = !0), h) return f = (0, u.default)(f, g), (0, d.default)(f, g.once), f
            }, y = function () {
                f = (0, p.default)(), m()
            };
        t.exports = {
            init: function (t) {
                return g = o(g, t), f = (0, p.default)(), function (t) {
                    return !0 === t || "mobile" === t && c.default.mobile() || "phone" === t && c.default.phone() || "tablet" === t && c.default.tablet() || "function" == typeof t && !0 === t()
                }(g.disable) || v ? void f.forEach((function (t, e) {
                    ...
                    m(!0)
                })), window.addEventListener("resize", (0, a.default)(m, 50, !0)), window.addEventListener("orientationchange", (0, a.default)(m, 50, !0)), window.addEventListener("scroll", (0, s.default)((function () {
                    (0, d.default)(f, g.once)
                }), 99)), document.addEventListener("DOMNodeRemoved", (function (t) {
                    var e = t.target;
                    e && 1 === e.nodeType && e.hasAttribute && e.hasAttribute("data-aos") && (0, a.default)(y, 50, !0)
                })), (0, l.default)("[data-aos]", y), f)
        ...
        (function (e) {
            ...
            function i(t, e, i) {
                function r(e) {
                    var i = u, n = p;
                    return u = p = void 0, m = e, h = t.apply(n, i)
                }

                function a(t) {
                    var i = t - g;
                    return void 0 === g || i >= e || i < 0 || T && t - m >= f
                }

                function l() {
                    var t = w();
                    return a(t) ? c(t) : void (v = setTimeout(l, function (t) {
                        var i = e - (t - g);
                        return T ? b(i, f - (t - m)) : i
                    }(t)))
                }

                function c(t) {
                    return v = void 0, k && u ? r(t) : (u = p = void 0, h)
                }
                ...
                function d() {
                    ...
                    if (u = arguments, p = this, g = t, i) {
                        if (void 0 === v) return function (t) {
                            return m = t, v = setTimeout(l, e), x ? r(t) : h
                        }(g);
                        if (T) return v = setTimeout(l, e), r(g)
                    }
                    return void 0 === v && (v = setTimeout(l, e)), h
                }

                var u, p, f, h, v, g, m = 0, x = !1, T = !1, k = !0;
                if ("function" != typeof t) throw new TypeError(s);
                return e = o(e) || 0, n(i) && (x = !!i.leading, f = (T = "maxWait" in i) ? y(o(i.maxWait) || 0, e) : f, k = "trailing" in i ? !!i.trailing : k), d.cancel = function () {
                    void 0 !== v && clearTimeout(v), m = 0, u = g = p = v = void 0
                }, d.flush = function () {
            ...
            function o(t) {
                ...
                t = t.replace(c, "");
                var i = u.test(t);
                return i || p.test(t) ? f(t.slice(2), i ? 2 : 8) : d.test(t) ? a : +t
            }
            ...
            var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
                ...
                }, s = "Expected a function", a = NaN, l = "[object Symbol]", c = /^\s+|\s+$/g, d = /^[-+]0x[0-9a-f]+$/i,
                ...
                g = h || v || Function("return this")(), m = Object.prototype.toString, y = Math.max, b = Math.min,
                w = function () {
                    return g.Date.now()
                };
            t.exports = function (t, e, o) {
                var r = !0, a = !0;
                if ("function" != typeof t) throw new TypeError(s);
                return n(o) && (r = "leading" in o ? !!o.leading : r, a = "trailing" in o ? !!o.trailing : a), i(t, e, {
                    leading: r,
                    maxWait: e,
                    trailing: a
                })
        ...
        (function (e) {
            ...
            function n(t) {
                ...
                t = t.replace(a, "");
                var n = c.test(t);
                return n || d.test(t) ? u(t.slice(2), n ? 2 : 8) : l.test(t) ? r : +t
            }
            ...
            var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
                    ...
                    return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : typeof t
                }, r = NaN, s = "[object Symbol]", a = /^\s+|\s+$/g, l = /^[-+]0x[0-9a-f]+$/i, c = /^0b[01]+$/i,
                ...
                h = p || f || Function("return this")(), v = Object.prototype.toString, g = Math.max, m = Math.min,
                y = function () {
                    return h.Date.now()
                };
            t.exports = function (t, e, o) {
                function r(e) {
                    var i = d, n = u;
                    return d = u = void 0, b = e, f = t.apply(n, i)
                }

                function s(t) {
                    var i = t - v;
                    return void 0 === v || i >= e || i < 0 || x && t - b >= p
                }

                function a() {
                    var t = y();
                    return s(t) ? l(t) : void (h = setTimeout(a, function (t) {
                        var i = e - (t - v);
                        return x ? m(i, p - (t - b)) : i
                    }(t)))
                }

                function l(t) {
                    return h = void 0, T && d ? r(t) : (d = u = void 0, f)
                }

                function c() {
                    var t = y(), i = s(t);
                    if (d = arguments, u = this, v = t, i) {
                        if (void 0 === h) return function (t) {
                            return b = t, h = setTimeout(a, e), w ? r(t) : f
                        }(v);
                        if (x) return h = setTimeout(a, e), r(v)
                    }
                    return void 0 === h && (h = setTimeout(a, e)), f
                }

                var d, u, p, f, h, v, b = 0, w = !1, x = !1, T = !0;
                if ("function" != typeof t) throw new TypeError("Expected a function");
                return e = n(e) || 0, i(o) && (w = !!o.leading, p = (x = "maxWait" in o) ? g(n(o.maxWait) || 0, e) : p, T = "trailing" in o ? !!o.trailing : T), c.cancel = function () {
                    void 0 !== h && clearTimeout(h), b = 0, d = v = u = h = void 0
                }, c.flush = function () {
                    return void 0 === h ? f : l(y())
                }, c
            }
        }).call(e, function () {
            return this
        ...
        function i() {
            for (var t, e, i = 0, o = r.length; i < o; i++) {
                t = r[i];
                for (var s, a = 0, l = (e = n.querySelectorAll(t.selector)).length; a < l; a++) (s = e[a]).ready || (s.ready = !0, t.fn.call(s, s))
            }
        }

        Object.defineProperty(e, "__esModule", {value: !0});
        var n = window.document, o = window.MutationObserver || window.WebKitMutationObserver, r = [], s = void 0;
        e.default = function (t, e) {
            r.push({selector: t, fn: e}), !s && o && (s = new o(i)).observe(n.documentElement, {
                childList: !0,
                subtree: !0,
                removedNodes: !0
            }), i()
        ...
        e.default = function (t, e) {
            var i = 0, o = 0, r = window.innerHeight, s = {
...
!function (t) {
    ...
    function i(i) {
        return this.each((function () {
            var n = t(this), o = n.data("bs.button"), r = "object" == typeof i && i;
    ...
    e.VERSION = "3.3.7", e.TRANSITION_DURATION = 600, e.DEFAULTS = {
        ...
        var o = this.$element.find(".item.active"), r = n || this.getItemForDirection(i, o), s = this.interval,
            a = "next" == i ? "left" : "right", l = this;
        if (r.hasClass("active")) return this.sliding = !1;
        var c = r[0], d = t.Event("slide.bs.carousel", {relatedTarget: c, direction: a});
    ...
    t.fn.collapse = n, t.fn.collapse.Constructor = e, t.fn.collapse.noConflict = function () {
        ...
        var r = i(o), s = r.data("bs.collapse") ? "toggle" : o.data();
        n.call(r, s)
    }))
}(jQuery), function (t) {
    "use strict";
    ...
    function o(i) {
        i && 3 === i.which || (t(".dropdown-backdrop").remove(), t(e).each((function () {
            var e = t(this), o = n(e), r = {relatedTarget: this};
    ...
    function i(i, n) {
        return this.each((function () {
            var o = t(this), r = o.data("bs.modal"), s = t.extend({}, e.DEFAULTS, o.data(), "object" == typeof i && i);
    ...
    e.VERSION = "3.3.7", e.TRANSITION_DURATION = 300, e.BACKDROP_TRANSITION_DURATION = 150, e.DEFAULTS = {
        ...
        var n = this, o = t.Event("show.bs.modal", {relatedTarget: i});
    ...
    e.VERSION = "3.3.7", e.TRANSITION_DURATION = 150, e.DEFAULTS = {
        ...
        var u = /top|bottom/.test(i), p = u ? 2 * d.left - o + l : 2 * d.top - r + c,
    ...
    function i(i) {
        return this.each((function () {
            var n = t(this), o = n.data("bs.affix"), r = "object" == typeof i && i;
    ...
    e.VERSION = "3.3.7", e.RESET = "affix affix-top affix-bottom", e.DEFAULTS = {
        ...
        if (this.$element.is(":visible")) {
            var i = this.$element.height(), n = this.options.offset, o = n.top, r = n.bottom,
    ...
    (e = function () {
        ...
        s.length ? (i = s.first(), n = i.attr("data-lazy"), (o = document.createElement("img")).onload = function () {
        ...
        if ("array" === t.type(r) && r.length) {
            for (e in o.respondTo = o.options.respondTo || "window", r) if (n = o.breakpoints.length - 1, i = r[e].breakpoint, r.hasOwnProperty(e)) {
    ...
    $(".ImagesFrameCrop").each((function () {
        $(this).removeClass("wide"), $(this).removeClass("tall"), $(this).width() / $(this).height() > $(this).parent().width() / $(this).parent().height() ? $(this).addClass("wide") : $(this).addClass("tall")
    ...
    $(this).parent(".collapse-item").addClass("active"), $(this).parent(".collapse-item").siblings().removeClass("active"), $(this).parent(".collapse-item").find(".collapse-content").slideDown(300), $(this).parent(".collapse-item").siblings().find(".collapse-content").slideUp(300)
    ...
    setTimeout((function () {
        $(".bs-modal").removeClass("show-modal"), $("body").removeClass("active-modal")
    }), 500), $(this).parents(".bs-modal").find(".content-modal").removeClass("show-modal")
})), $(".show__menu").click((function () {
    $(".menu").toggleClass("active"), $(".menu-top").removeClass("active")
})), $(".close__menu").click((function () {
    $(".menu").removeClass("active")
})), $(".show__top").click((function () {
    $(".menu-top").toggleClass("active"), $(".menu").removeClass("active")
})), $(".close__top").click((function () {
    $(".menu-top").removeClass("active")
})), $(".bs-tooltip").each((function () {
    $(this).find(".tooltip__desc").remove(), "" != $(this).attr("tooltip-data") && $(this).append("<span class='tooltip__desc'>" + $(this).attr("tooltip-data") + "</span>")
}));
