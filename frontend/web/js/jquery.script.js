...
jQuery(document).ready(function() { 
	...
	jQuery(document).ready(function (){
		...
		jQuery("#cmsmasters_slider_b7d2b499c1").owlCarousel({
			nav: true,
			dots:false,
			responsive : {
	...
	jQuery(document).ready(function (){
		jQuery("#cmsmasters_quotes_slider_65261cd97d").owlCarousel({
			nav:false,
			dots:false,
			responsive : {
				// breakpoint from 0 up
	...
	jQuery(document).ready(function (){
		jQuery("#cmsmasters_slider_e1ee51ecfc").owlCarousel({
			nav: true,
			dots:false,
			responsive : {
				// breakpoint from 0 up
...
function cmsmasters_owl_sliders_run() {
	var owl_sliders = jQuery('.cmsmasters_owl_slider12');
