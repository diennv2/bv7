...
$this->title = "Bạn bè của tôi " . $user->firstname;
    ...
    <div class="row">
        ...
        <?php if (!Yii::$app->user->isGuest): ?>
            <div class="col-xs-12 col-md-8" style="text-align: right">
                <h1 style="text-align: left;font-weight: bold;font-size: 16px">Bạn bè của tôi</h1>
                <style>
                ...
                echo \yii\widgets\ListView::widget([
                    ...
                    'emptyText' => (Yii::$app->user->identity->id != $user->id) ? '<p class="alert alert-warning">Người này chưa kết bạn với ai!</p>' : "",
                    ...
                    'summary'=>'<b>{totalCount}</b> người bạn',
                    'itemView' => function ($order, $key, $index, $widget) use ($config, $user) {
                        return $this->render('_listfriend', [
                            'model' => $order,
                            'user' => $user,
                            'config' => $config
                        ]);
