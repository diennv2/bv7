...
class News extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['hot', 'home', 'active', 'luotxem', 'lang_id', 'cat_new_id','pheduyet'], 'integer'],
            [['cat_new_id'], 'required'],
...
//            [['brief'], 'string', 'max' => 250],
   ...
   public function getLink(){
        return Yii::$app->urlManager->createUrl(['site/news', 'catname' => $this->catNew->url, 'url' => $this->url, 'id' => $this->id]);
   }
    public function getUrl(){
        return Yii::$app->urlManager->createUrl(['site/news', 'id' => $this->id, 'url' => $this->url, 'catname' => \func::taoduongdan($this->catNew->name)]);
    }
}
