...
class Catproduct extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['url', 'image','image_km', 'small_icon', 'description', 'seo_desc'], 'string'],
            [['ord', 'home', 'active', 'lang_id', 'parent', 'menustyle', 'menu', 'home2'], 'integer'],
    ...
    public function getUrl(){
        return Yii::$app->urlManager->createUrl(['product/product', 'path' => \func::taoduongdan($this->name), 'id' => $this->id]) ;
    }
    public function getUrl2(){
        return Yii::$app->urlManager->createUrl(['product/product2', 'path' => \func::taoduongdan($this->name), 'id' => $this->id]) ;
    }
    public function getProductsIsNotActive()
    {
        $cats = Catproduct::find()->where(['active'=>1])->all();
        return $cats;
    }
